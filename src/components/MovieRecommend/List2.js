...
const List2 = () => 
{
    ...
    const submit = async (event) => 
    {
        ...
        const recommendedMovies = await axios.post('https://7kqfgbanwg.execute-api.us-east-1.amazonaws.com/prod/', { userInput: arrayForRecommend, "Content-type": "text/plain" })
